...
This assumes you have [tf2-loadouts-script](https://github.com/jooonior/tf2-loadouts-script) set up, because the way this is set up accounts for it (because its what I like using)
